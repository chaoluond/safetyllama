...
@dataclass
class safetyllama_finetune_dataset:
    dataset: str = "safetyllama_finetune_dataset"
    train_split: str = "train"
    test_split: str = "val"
    data_path: str = "llama_recipes/datasets/safety_evaluation_chatgpt_3.5_no_duplicates.jsonl"
